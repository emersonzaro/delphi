...
begin
  if ((Trim(edCompra01.Text)) = '') or ((Trim(edCompra02.Text)) = '') or
    ...
    ShowMessage('O valor da compra não pode ser vazio!')
  else
  begin
    ...
    ShowMessage('O valor total das compras é: ' + FloatToStr(total));
  end
...
begin
  ...
  begin
    ...
    ShowMessage('O valor médio da compra é: ' + FloatToStr(media));
  end;
